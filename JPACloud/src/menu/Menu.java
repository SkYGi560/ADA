...
import bdcloud.InfraestructuraJpaController;
import bdcloud.JPAUtil;
import bdcloud.JPAVista;
...
public class Menu {
    ...
    public static void mostrar() {
        ...
        try (EntityManagerFactory emf = JPAUtil.getEntityManagerFactory()) {
            InfraestructuraJpaController dao = new InfraestructuraJpaController(emf);
            ...
            while (!salir) {
                ...
                System.out.println(Colores.LETRA_AZUL + "1. Mostrar infraestructura de una plataforma (JPQL)");
                System.out.println(Colores.LETRA_AZUL + "2. Modificar infraestructura");
                ...
                try {
                    ...
                    switch (opcion) {
                        case 1 ->
                            JPAVista.verInfraestructuraPorTipo(dao);
                        case 2 ->
                            JPAVista.modificarInfraestructura(dao);
                        case 0 -> {
                            salir = true;
