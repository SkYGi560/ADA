...
import seriestv.ActoresJpaController;
...
public class Menu {
    ...
    public static void mostrar() {
        ...
        try (EntityManagerFactory emf = JPAUtil.getEntityManagerFactory()) {
            ...
            ActoresJpaController ActoresDao = new ActoresJpaController(emf);
            ...
            while (!salir) {
                ...
                System.out.println(Colores.LETRA_AZUL + "5. Modificar canal de TV");
                System.out.println(Colores.LETRA_AZUL + "6. Modificar Serie");
                System.out.println(Colores.LETRA_AZUL + "7. Eliminar Serie");
                System.out.println(Colores.LETRA_AZUL + "8. Añadir actor");
                System.out.println(Colores.LETRA_AZUL + "9. Añadir participacion");
                System.out.println(Colores.LETRA_AZUL + "10. Mostrar Actores");
                ...
                try {
                    ...
                    switch (opcion) {
                        ...
                        case 5 ->
                            JPAVista.modificarCanal(CanalesDao);
                        case 6 ->
                            JPAVista.modificarSerie(SeriesDao);
                        case 7 ->
                            JPAVista.eliminarSerie(SeriesDao);
                        case 8 ->
                            JPAVista.addActor(ActoresDao);
                        case 9 ->
                            JPAVista.addParticipacion(SeriesDao, ActoresDao);
                        case 10 ->
                            JPAVista.verActoresController(ActoresDao);
                        case 0 -> {
                            salir = true;
