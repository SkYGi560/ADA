...
public class JPAVista {
    ...
    public static void mostrarSeriesPorCanal(SeriesJpaController dao) {
        EntityManager em = null;
        try {
            em = dao.getEntityManager();
            Query query = em.createQuery(
                    "SELECT ser.tv, COUNT(ser.codigo) as totalseries FROM Series ser GROUP BY ser.tv");
            List<Object[]> lista = query.getResultList();
            System.out.println("+------------+----------+");
            System.out.println("| Canal TV | Duración |");
            System.out.println("+------------+----------+");
